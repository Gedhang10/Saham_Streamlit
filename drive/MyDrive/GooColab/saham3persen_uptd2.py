...
drive.mount('/content/drive/MyDrive/GooColab')

!git add /content/drive/MyDrive/GooColab/saham3persen.py
! streamlit run saham3persen.py & npx localtunnel --port 8501